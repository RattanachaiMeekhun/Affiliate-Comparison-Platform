  ...
  return (
    <AnimatedPage>
      <div className="container" style={{ paddingTop: 32, paddingBottom: 48 }}>
        ...
        >
          <div style={{ fontSize: 40, marginBottom: 12, position: 'relative', width: 40, height: 40 }}>
            {category.icon_url ? (
              <Image src={category.icon_url} alt={category.name} fill style={{ objectFit: 'contain' }} />
            ) : (
              '📂'
            )}
          </div>
        ...
        {/* Category Buying Guide / Extra SEO Content */}
        <section style={{ marginTop: 64, borderTop: '1px solid var(--border)', paddingTop: 48 }}>
          <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 20 }}>Buying Guide: Best {category.name} for Professionals</h2>
          <div style={{ color: 'var(--text-secondary)', lineHeight: 1.7, fontSize: 15 }}>
            <p style={{ marginBottom: 16 }}>
              Looking for the best {category.name.toLowerCase()}? Whether you are a Data Scientist training complex models, a Video Editor working with 4K RAW footage, or a 3D Artist rendering in Blender, choosing the right {category.name.toLowerCase()} is crucial for your workflow productivity.
            </p>
            <p>
              At stacknodes, our AI analyzes technical specifications and real-world benchmarks to help you find the perfect balance between performance and price. Check out our curated list above to find the latest deals from top retailers.
            </p>
          </div>
        </section>
              ...
              itemListElement: [
                {
                  ...
                  position: 1,
                  name: 'Home',
                  item: 'https://stacknodes.net/',
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: 'Categories',
                  item: 'https://stacknodes.net/category',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: category.name,
                  item: `https://stacknodes.net/category/${category.slug}`,
                },
              ],
            }),
          }}
