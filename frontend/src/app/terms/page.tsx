...
export const metadata: Metadata = {
  title: 'Terms of Service - PixelStack',
  description: 'Terms of Service for using PixelStack.',
};

export default function TermsPage() {
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
      <h1 style={{ fontSize: '2.5rem', marginBottom: '10px' }}>Terms of Service for PixelStack.io</h1>
