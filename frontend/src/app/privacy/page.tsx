...
export const metadata: Metadata = {
  title: 'Privacy Policy - PixelStack',
  description: 'Privacy Policy and data collection guidelines for PixelStack.',
};

export default function PrivacyPage() {
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
      <h1 style={{ fontSize: '2.5rem', marginBottom: '10px' }}>Privacy Policy for PixelStack.io</h1>
      <p style={{ color: 'var(--text-secondary)', marginBottom: '30px' }}><strong>Last Updated: March 1, 2026</strong></p>

      <div style={{ lineHeight: '1.8' }}>
        <p style={{ marginBottom: '20px' }}>
          At PixelStack.io, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by PixelStack.io and how we use it.
        </p>
        ...
        <p style={{ fontStyle: 'italic', color: 'var(--text-secondary)' }}>
          For questions regarding this policy, please contact us at support@pixelstack.io.
        </p>
      </div>
    </div>
  );
